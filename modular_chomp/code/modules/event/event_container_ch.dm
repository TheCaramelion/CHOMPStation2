...
#define ASSIGNMENT_FRONTIERDEFENSE "NT Frontier Defense"
#define ASSIGNMENT_COMMANDER "NTFD Commander"
#define ASSIGNMENT_LIEUTENANT_COMMANDER "NTFD Lieutenant Commander"
...
/datum/event_container/mundane/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Lone Spacefish",		/datum/event/spacefish_migration, 			0,	list(ASSIGNMENT_FRONTIERDEFENSE = 15), 1, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 3)),
	...
	add_disabled_events(list(
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Lost Carp",				/datum/event/carp_migration, 				0, 		list(ASSIGNMENT_FRONTIERDEFENSE = 40), 1, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 1)),
...
//		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Lost Spiders",			/datum/event/spider_migration, 				0, 		list(ASSIGNMENT_FRONTIERDEFENSE = 10), 1), //YW EDIT //CHOMPStation Edit: Moved to disabled and commented. This just spawns spiders on carp spawns.
	))
...
/datum/event_container/moderate/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Camera Damage",				/datum/event/camera_damage,				20, 	list(ASSIGNMENT_FRONTIERDEFENSE = 5, ASSIGNMENT_ENGINEER = 20), min_jobs = list(ASSIGNMENT_ENGINEER = 1)),
		// Just disables comms for a short while.
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Communication Blackout",	/datum/event/communications_blackout,	500,	list(ASSIGNMENT_AI = 100, ASSIGNMENT_FRONTIERDEFENSE = 50), 1),
		...
		//new /datum/event_meta(EVENT_LEVEL_MODERATE, "Escaped Slimes",			/datum/event/escaped_slimes, 			-40,	list(ASSIGNMENT_SCIENTIST = 30, ASSIGNMENT_FRONTIERDEFENSE = 20)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Grub Infestation",			/datum/event/grub_infestation,			-20,	list(ASSIGNMENT_FRONTIERDEFENSE = 40, ASSIGNMENT_ENGINEER = 40), 1),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Jellyfish School",			/datum/event/jellyfish_migration,		5,		list(ASSIGNMENT_ANY = 1, ASSIGNMENT_FRONTIERDEFENSE = 5, ASSIGNMENT_MEDICAL = 3), 1),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Maintenance Predator",		/datum/event/maintenance_predator,		75,		list(ASSIGNMENT_FRONTIERDEFENSE = 25, ASSIGNMENT_SCIENTIST = 10), 1),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Mutants",					/datum/event/mutants,					20,		list(ASSIGNMENT_ANY = 15, ASSIGNMENT_FRONTIERDEFENSE = 25), 1),
		// Opens doors in brig.  So just RP fun
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Prison Break",				/datum/event/prison_break,				-10,	list(ASSIGNMENT_FRONTIERDEFENSE = 30, ASSIGNMENT_ENGINEER = 20), 1, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 2)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Rogue Drones",				/datum/event/rogue_drone, 				-30,	list(ASSIGNMENT_FRONTIERDEFENSE = 25, ASSIGNMENT_COMMANDER = 35, ASSIGNMENT_LIEUTENANT_COMMANDER = 35), min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 2)),
		// Radiation, but only in space.
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Solar Storm",				/datum/event/solar_storm, 				20,		list(ASSIGNMENT_ENGINEER = 40, ASSIGNMENT_FRONTIERDEFENSE = 20), 1),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Space Dust",				/datum/event/dust,	 					0,		list(ASSIGNMENT_ENGINEER = 20), 1, 0, 50),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Spacefish Migration",		/datum/event/spacefish_migration,		0, 		list(ASSIGNMENT_FRONTIERDEFENSE = 40, ASSIGNMENT_MEDICAL = 5), 1, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 3)),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Spider Infestation",		/datum/event/spider_infestation, 		-20,	list(ASSIGNMENT_FRONTIERDEFENSE = 30, ASSIGNMENT_COMMANDER = 20, ASSIGNMENT_LIEUTENANT_COMMANDER = 20), 0, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 1)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Xenobiology Breach",		/datum/event/prison_break/xenobiology,	0,		list(ASSIGNMENT_SCIENCE = 100), 1, min_jobs = list(ASSIGNMENT_SCIENTIST = 1), min_jobs = list(ASSIGNMENT_SCIENTIST = 1, ASSIGNMENT_FRONTIERDEFENSE =1)),
	)
	add_disabled_events(list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Random Antagonist",		/datum/event/random_antag,		 		2.5,	list(ASSIGNMENT_FRONTIERDEFENSE = 1), 1, 0, 5),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Carp School",				/datum/event/carp_migration,			-20, 	list(ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_FRONTIERDEFENSE = 30, ASSIGNMENT_COMMANDER = 10, ASSIGNMENT_LIEUTENANT_COMMANDER = 5), 1, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 2)),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Supply Demand",			/datum/event/supply_demand,				0,		list(ASSIGNMENT_ANY = 5, ASSIGNMENT_SCIENCE = 15, ASSIGNMENT_GARDENER = 10, ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_MEDICAL = 15), 1),
...
//		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Lost Spiders",				/datum/event/spider_migration,			0, 		list(ASSIGNMENT_FRONTIERDEFENSE = 30), 1), //YW EDIT //CHOMPStation Edit: Moved to disabled. This is a YW feature that spawns spiders on carp spawns.
	))
...
/datum/event_container/major/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Blob",						/datum/event/blob, 						-100,	list(ASSIGNMENT_FRONTIERDEFENSE = 40, ASSIGNMENT_COMMANDER = 10, ASSIGNMENT_LIEUTENANT_COMMANDER = 10, ASSIGNMENT_ENGINEER = 5), 1, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 1)),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Carp Migration",				/datum/event/carp_migration,			-110,	list(ASSIGNMENT_FRONTIERDEFENSE = 50, ASSIGNMENT_COMMANDER = 10, ASSIGNMENT_LIEUTENANT_COMMANDER = 10), 1, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 3)),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Horde Infestation",			/datum/event/horde_infestation, 		-60,	list(ASSIGNMENT_FRONTIERDEFENSE = 20, ASSIGNMENT_COMMANDER = 10, ASSIGNMENT_LIEUTENANT_COMMANDER = 10, ASSIGNMENT_ANY = 3), 0),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Jellyfish Migration",			/datum/event/jellyfish_migration,		5,		list(ASSIGNMENT_ANY = 1, ASSIGNMENT_FRONTIERDEFENSE = 5, ASSIGNMENT_MEDICAL = 3), 1),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Spacefish Swarm",				/datum/event/spacefish_migration,		10,		list(ASSIGNMENT_FRONTIERDEFENSE = 5, ASSIGNMENT_MEDICAL = 3), 1, min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 3)),
	...
	add_disabled_events(list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Spider Infestation",			/datum/event/spider_infestation, 		-60,	list(ASSIGNMENT_FRONTIERDEFENSE = 20, ASSIGNMENT_COMMANDER = 10, ASSIGNMENT_LIEUTENANT_COMMANDER = 10, ASSIGNMENT_ANY = 3), 0),
		//Metroids moved into horde infestation
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Metroid Infestation",			/datum/event/metroid_infestation,		-100,	list(ASSIGNMENT_FRONTIERDEFENSE = 30, ASSIGNMENT_SCIENCE = 20, ASSIGNMENT_COMMANDER = 15, ASSIGNMENT_LIEUTENANT_COMMANDER = 15, ASSIGNMENT_ANY = 2), 1 , min_jobs = list(ASSIGNMENT_FRONTIERDEFENSE = 2, ASSIGNMENT_SCIENCE = 1)),
...
#undef ASSIGNMENT_FRONTIERDEFENSE
#undef ASSIGNMENT_COMMANDER
#undef ASSIGNMENT_LIEUTENANT_COMMANDER
