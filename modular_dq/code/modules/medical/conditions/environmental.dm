...
/datum/medical_issue/condition/acute_radiation
	...
	progression_rate = 0
	cured_by = list(REAGENT_ID_HYRONALIN = 1.2, REAGENT_ID_ARITHRAZINE = 0.8)

/datum/medical_issue/condition/acute_radiation/get_stages()
	var/static/list/S = list(
		"Mild" = list(
			"name" = "acute radiation sickness (mild)",
		...
		"Moderate" = list(
			"name" = "acute radiation sickness (moderate)",
		...
		"Severe" = list(
			"name" = "acute radiation sickness (severe)",
...
/datum/medical_issue/condition/chronic_radiation
	...
	progression_rate = 0
	cured_by = list(REAGENT_ID_HYRONALIN = 0.8, REAGENT_ID_ARITHRAZINE = 0.4)
	symptom_pool = list(
		/datum/medical_symptom/fatigue            = 80,
...
/datum/medical_issue/condition/toxic_poisoning
	...
	progression_rate = 0
	cured_by = list(REAGENT_ID_ANTITOXIN = 1.0, REAGENT_ID_TRICORDRAZINE = 0.3)
	symptom_pool = list(
...
/datum/medical_issue/condition/hypothermia
	...
	progression_rate = 0
	cured_by = list(REAGENT_ID_BICARIDINE = 0.4, REAGENT_ID_DERMALINE = 0.5)
	symptom_pool = list(
...
/datum/medical_issue/condition/heatstroke
	...
	progression_rate = 0
	cured_by = list(REAGENT_ID_DERMALINE = 0.5, REAGENT_ID_KELOTANE = 0.3)
	symptom_pool = list(
...
/datum/medical_issue/condition/genetic_damage
	...
	progression_rate = 0
	cured_by = list(REAGENT_ID_RYETALYN = 1.0)
	symptom_pool = list(
		/datum/medical_symptom/fatigue              = 60,
