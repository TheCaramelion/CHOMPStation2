/obj/item/device/encryptionkey/heads/hop
	...
	channels = list("Supply" = 1, "Service" = 1, "Command" = 1, "NTFD" = 1) //YW Edit: removes Explorer channel access, not in line with our chain of command. CHOMP: We accept this

/obj/item/device/encryptionkey/heads/ai_integrated
	name = "ai integrated encryption key"
	desc = "Integrated encryption key"
	icon_state = "cap_cypherkey"
	channels = list("Command" = 1, "NTFD" = 1, "Engineering" = 1, "Science" = 1, "Medical" = 1, "Supply" = 1, "Service" = 1, "AI Private" = 1, "Away Team" = 1) // CHOMPEdit

/obj/item/device/encryptionkey/heads/captain
	name = "site manager's encryption key"
	icon_state = "cap_cypherkey"
	channels = list("Command" = 1, "NTFD" = 1, "Engineering" = 1, "Science" = 1, "Medical" = 1, "Supply" = 1, "Service" = 1, "Away Team" = 1)
...
/obj/item/device/encryptionkey/ert
	channels = list("Response Team" = 1, "Science" = 1, "Command" = 1, "Medical" = 1, "Engineering" = 1, "NTFD" = 1, "Supply" = 1, "Service" = 1, /*"Explorer" = 1*/) //CHOMP explo keep

/obj/item/device/encryptionkey/omni		//Literally only for the admin intercoms
	channels = list("Mercenary" = 1, "Raider" = 1, "Response Team" = 1, "Science" = 1, "Command" = 1, "Medical" = 1, "Engineering" = 1, "NTFD" = 1, "Supply" = 1, "Service" = 1, /*"Explorer" = 1*/) //CHOMP explo keep
